...
VALUES (1, NULL, 'seuEmail@gmail.com', NULL, -23.520024100000001E0, -46.596497999999997E0, 0xCEFC236338876228A53A3A4D955B589D80A1C45A9EAA58C5AC73771C3760D27871F2BEA12C761954D683A527A2C1224FC74875479AD31B0BBB985270E5C30A12, , 'Admin', 'UsuarioAdmin');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'DataAcesso', N'Email', N'Foto', N'Latitude', N'Longitude', N'PasswordHash', N'PasswordSalt', N'Perfil', N'Username') AND [object_id] = OBJECT_ID(N'[TB_USUARIOS]'))
...
VALUES (N'20240416234023_MigracaoUsuario', N'8.0.3');
GO
