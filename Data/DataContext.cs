...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<Personagem>().ToTable("TB_PERSONAGENS"); //definicao da tabela no banco de dados
            ...
            (
                new Arma() { Id = 1, Nome = "Tauros", Dano = 60, PersonagemId = 1},
                new Arma() { Id = 2, Nome = "Desert-Eagle", Dano = 100, PersonagemId = 2},
                new Arma() { Id = 3, Nome = "P90", Dano = 35, PersonagemId = 3},
                new Arma() { Id = 4, Nome = "M4", Dano = 70, PersonagemId = 4},
                new Arma() { Id = 5, Nome = "Magnum", Dano = 90, PersonagemId = 5},
                new Arma() { Id = 6, Nome = "Glock", Dano = 50, PersonagemId = 6},
                new Arma() { Id = 7, Nome = "Sniper", Dano = 110, PersonagemId = 7}
            );
        ...
        user.Perfil = "Admin";
        user.Email  = "seuEmail@hotmail.com";
